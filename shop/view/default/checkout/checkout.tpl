                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-collapse" id="collapse-payment-method">
                            <div class="panel-body">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="shipping_method" value="balance" {if $shipping_method=='balance'}checked{/if} />余额支付</label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="shipping_method" value="wechat" {if $shipping_method=='wechat'}checked{/if} />微信支付</label>
                                </div>
                            </div>
                        </div>
                    </div>
