...
class ProductAttrModel extends MysqlModel{
	...
	public function updateAttr($attr_id,$data){

		return $this->update($data,array('attr_id'=>$attr_id));
	}

	public function getAttr($attr_id){

		return $this->one(array('attr_id'=>$attr_id));
	}
